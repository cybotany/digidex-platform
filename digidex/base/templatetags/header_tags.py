...
@register.inclusion_tag("base/includes/header/information.html", takes_context=True)
...
@register.inclusion_tag("base/includes/header/internal_links.html", takes_context=True)
...
@register.inclusion_tag("base/includes/header/social_links.html", takes_context=True)
...
@register.inclusion_tag("base/includes/header/copyright.html", takes_context=True)
