...
import digidex.utils.validators
from django.conf import settings
import django.contrib.auth.models
import django.contrib.auth.validators
from django.db import migrations, models
from digidex.accounts.models import profile_avatar_directory_path
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, help_text='The profile picture of the user.', null=True, storage=digidex.utils.custom_storage.PublicMediaStorage(), upload_to=profile_avatar_directory_path, validators=[digidex.utils.validators.validate_profile_avatar])),
