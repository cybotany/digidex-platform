# Generated by Django 5.0.2 on 2024-06-03 18:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('introduction', models.TextField(blank=True, help_text='Short Biography about the user.', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detail_page', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='inventory.digitalobjectpage')),
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='itemized_digits', to='inventory.inventorycategorypage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sort_order', models.IntegerField(blank=True, editable=False, null=True)),
                ('detail_page', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='inventory.inventorycategorypage')),
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='inventory_categories', to='inventory.userprofilepage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('journalentry_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='inventory.journalentry')),
                ('sort_order', models.IntegerField(blank=True, editable=False, null=True)),
            ...
            bases=('inventory.journalentry', models.Model),
        ),
        migrations.CreateModel(
            name='InventoryCategoryJournalEntry',
            fields=[
                ('journalentry_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='inventory.journalentry')),
                ('sort_order', models.IntegerField(blank=True, editable=False, null=True)),
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='journal_entries', to='inventory.inventorycategorypage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
