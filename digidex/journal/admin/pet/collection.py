...
class PetCollection(admin.ModelAdmin):
    ...
    search_fields = ('pet__name', 'entries__content')
    ...
    def get_queryset(self, request):
        ...
        return super().get_queryset(request).prefetch_related('pet', 'entries')
    ...
    get_entity_name.short_description = 'Pet Name'

    def get_entity_description(self, obj):
        return obj.get_entity_description()
    get_entity_description.short_description = 'Pet Description'
