...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='avatar',
            field=base.fields.django_fields.BaseImageField(blank=True, help_text='The avatar image of the profile.', null=True, storage=base.utils.storage.PublicMediaStorage, upload_to=persona.models.profile_avatar_directory_path),
        ),
        migrations.AlterField(
            model_name='digidexprofile',
            name='bio',
