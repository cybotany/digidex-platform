...
urlpatterns = [
    ...
    path('a/plant_registration', AutoPlantRegistration.as_view(), name='auto_plant_form'),
    path('m/plant_registration', ManualPlantRegistration.as_view(), name='manual_plant_form'),
