...
from apps.accounts.models import profile_avatar_directory_path
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, help_text='The profile picture of the user.', null=True, storage=apps.utils.custom_storage.PublicMediaStorage(), upload_to=profile_avatar_directory_path, validators=[apps.utils.validators.validate_profile_avatar])),
