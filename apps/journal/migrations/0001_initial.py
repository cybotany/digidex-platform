    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, help_text='(Optional) The image to save with the journal entry. Only .jpg, .png, and .jpeg extensions are allowed.', null=True, storage=apps.utils.custom_storage.PrivateMediaStorage(), upload_to=journal_entry_directory_path, validators=[apps.utils.validators.validate_journal_entry])),
