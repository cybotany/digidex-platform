...
from accounts.models import profile_avatar_directory_path
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, help_text='The profile picture of the user.', null=True, storage=utils.custom_storage.PublicMediaStorage(), upload_to=profile_avatar_directory_path, validators=[utils.validators.validate_profile_avatar])),
